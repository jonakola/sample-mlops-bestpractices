...
def full_command(args):
    ...
    print("  2. Deployment: notebooks/2_deployment.ipynb")
    print("  3. Monitoring: notebooks/3_inference_monitoring.ipynb")
    print("  4. Dashboard: notebooks/4_governance_dashboard.ipynb")
